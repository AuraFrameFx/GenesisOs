...
val specFiles = specDir.listFiles { f -> f.extension == "yml" || f.extension == "yaml" } ?: emptyArray()

specFiles.forEach { specFile ->
    val specName = specFile.nameWithoutExtension
    tasks.register("generateOpenApi_${specName}", org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
